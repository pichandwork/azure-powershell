...
{
    /// <summary>
    /// Defines the New-AzWafFrontDoorMatchConditionObject cmdlet.
    /// </summary>
    [Cmdlet("New", ResourceManager.Common.AzureRMConstants.AzureRMPrefix + "WafFrontDoorMatchConditionObject"), OutputType(typeof(PSMatchCondition))]
